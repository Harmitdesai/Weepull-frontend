  ...
  return (
        <Dialog key={post.postId}>
            <DialogTrigger asChild>
                <Card className="h-[250px] relative cursor-pointer group overflow-hidden bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-xl border border-white/10 hover:border-purple-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/10">
                    ...
                    <CardHeader className="relative z-10">
                        <CardTitle className="flex-[0_0_60%] text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-white to-gray-300 line-clamp-3 group-hover:from-blue-200 group-hover:to-purple-200 transition-all duration-300">
                        {post.title}
                        </CardTitle>
                    </CardHeader>
            ...
            <DialogContent className="sm:max-w-[425px] backdrop-blur-2xl bg-black/40 rounded-2xl p-0 shadow-2xl border border-white/10 text-white overflow-hidden">
                ...
                <div className="absolute top-0 left-0 right-0 h-32 bg-gradient-to-br from-blue-500/20 via-purple-500/10 to-transparent pointer-events-none"></div>
                ...
                <div className="relative p-8 space-y-4">
                    <DialogHeader className="bg-white/10 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 p-6">
                        ...
                        <DialogDescription className="text-gray-300 flex items-center gap-2 mt-2">
                            <span className="px-2 py-1 rounded-md bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-white/10 text-sm">
                                {post.type}
                            </span>
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl shadow-lg border border-white/15 p-5">
                        <span className="text-blue-300 font-semibold text-sm uppercase tracking-wide">Description</span>
                    ...
                    <div className="bg-white/5 backdrop-blur-sm rounded-xl shadow-lg border border-white/10 p-5">
                        <span className="text-purple-300 font-semibold text-sm uppercase tracking-wide">Example</span>
