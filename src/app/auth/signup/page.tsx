      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl shadow-2xl shadow-black/30 p-8 space-y-6">
          ...
          <div className="text-center space-y-2">
            <div className="w-12 h-12 mx-auto rounded-xl bg-gradient-to-br from-purple-500 to-cyan-500 flex items-center justify-center shadow-lg shadow-purple-500/25 mb-4">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-500 hover:to-cyan-500">
              Create Account
            </Button>
          </form>
          ...
          <p className="text-sm text-center text-gray-400">
            ...
            <a href="/auth/login" className="text-purple-400 hover:text-purple-300 transition-colors font-medium">
              Sign in
            </a>
          </p>
