...
const DataRequests = () => {
  ...
  return (
    <div className="relative">
        ...
        <div className="px-8 pb-24">
            ...
            {posts.map((post, index) => (
                ...
                <DialogTrigger asChild>
                    <Card className="h-[250px] relative cursor-pointer group overflow-hidden bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-xl border border-white/10 hover:border-cyan-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-cyan-500/10">
                        ...
                        <div className="absolute -inset-1 bg-gradient-to-r from-purple-500/20 to-cyan-500/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10"></div>
                        
                        <CardHeader className="relative z-10">
                            <CardTitle className="flex-[0_0_60%] text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-white to-gray-300 line-clamp-3 group-hover:from-purple-200 group-hover:to-cyan-200 transition-all duration-300">
                                {post.title}
                            </CardTitle>
                ...
                <DialogContent className="sm:max-w-[425px] backdrop-blur-2xl bg-black/40 rounded-2xl p-0 shadow-2xl border border-white/10 text-white overflow-hidden">
                    <div className="absolute top-0 left-0 right-0 h-32 bg-gradient-to-br from-purple-500/20 via-cyan-500/10 to-transparent pointer-events-none"></div>
                    ...
                    <div className="relative p-8 space-y-4">
                        <DialogHeader className="bg-white/10 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 p-6">
                            ...
                            <DialogDescription className="text-gray-300 flex items-center gap-2 mt-2">
                                <span className="px-2 py-1 rounded-md bg-gradient-to-r from-purple-500/20 to-cyan-500/20 border border-white/10 text-sm">
                                    {post.type}
                                </span>
                            </DialogDescription>
                        </DialogHeader>
                        ...
                        <div className="bg-white/10 backdrop-blur-sm rounded-xl shadow-lg border border-white/15 p-5">
                            <span className="text-purple-300 font-semibold text-sm uppercase tracking-wide">Description</span>
                        ...
                        <div className="bg-white/5 backdrop-blur-sm rounded-xl shadow-lg border border-white/10 p-5">
                            <span className="text-cyan-300 font-semibold text-sm uppercase tracking-wide">Example</span>
                            <p className="text-gray-300 mt-2 leading-relaxed">{post.example}</p>
                        </div>
                        
                        <DialogFooter className="pt-2">
                            <Button 
                                className="bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-500 hover:to-cyan-500 rounded-xl shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 border border-white/10 px-6 py-5 font-semibold transition-all duration-300 hover:scale-105"
                                onClick={() => {
        ...
        <Dialog>
            <DialogTrigger asChild>
                <Button className="fixed bottom-8 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-500 hover:to-cyan-500 rounded-full shadow-2xl shadow-purple-500/25 hover:shadow-purple-500/40 border border-white/10 px-8 py-6 text-base font-semibold transition-all duration-300 hover:scale-105">
                    Request Data
                </Button>
            </DialogTrigger>
